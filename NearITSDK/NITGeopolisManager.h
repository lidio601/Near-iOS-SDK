...
- (instancetype _Nonnull)initWithNodesManager:(NITGeopolisNodesManager* _Nonnull)nodesManager cachaManager:(NITCacheManager* _Nonnull)cacheManager networkManager:(id<NITNetworkManaging> _Nonnull)networkManager configuration:(NITConfiguration* _Nonnull)configuration locationManager:(CLLocationManager* _Nullable)locationManager trackManager:(NITTrackManager* _Nonnull)trackManager;
